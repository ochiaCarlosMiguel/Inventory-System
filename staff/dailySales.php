...
<body>
            ...
            <div class="topbar">
                ...
                <div class="profile-container">
                    ...
                    <div class="dropdown-content">
                        <a href="../admin/logout.php" id="logoutBtn"><i class="fas fa-sign-out-alt"></i>Logout</a>
                    </div>
                </div>
            </div>
            ...
            <div class="main-content">
                <div class="content-card dashboard-table">
                    <div class="table-header">
                        ...
                        <a href="../admin/exportDailySales.php" class="export-btn">
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                // Updated Sidebar Dropdowns functionality
                const dropdowns = document.querySelectorAll('.sidebar .dropdown');
                
                dropdowns.forEach(dropdown => {
                    const toggleBtn = dropdown.querySelector('a'); // Changed to select any 'a' element
