...
$endDate = date('Y-m-t'); // t will get the last day of the current month

try {
    // Updated query to show individual sales correctly
    $query = "SELECT 
                p.product_title,
                p.buying_price,
                ...
                s.sale_date as first_sale_date
            FROM sales s
            ...
            <div class="main-content">
                <div class="content-card dashboard-table">
                    <div class="table-header">
                        ...
                        <h2>MONTHLY SALES</h2>
                        <a href="exportMonthlySales.php" class="export-btn">
                            ...
                            <tbody>
                                ...
                                <?php else: ?>
                                    ...
                                    <tr class="total-row">
                                        ...
                                        <td colspan="3"><strong>₱<?php echo number_format($totalCostOfSales, 3); ?></strong></td>
                                    </tr>
                                    <tr class="total-row">
