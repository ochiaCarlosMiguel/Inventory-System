        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                function checkForChanges() {
                    ...
                    inputs.forEach(input => {
                        // Skip checking price input since it's readonly
                        if (!input.classList.contains('price-input') && input.value !== originalValues[input.className]) {
                            hasChanges = true;
                        }
                    });
                ...
                document.querySelector('.qty-input').addEventListener('input', function(e) {
                    ...
                    const availableQty = parseInt(this.dataset.available);
